...
const Card = ({ children, title, collapsable = false }) => {
  const [collapsed, setCollapsed] = useState(true)

  return (
    <div className="p-6 bg-white md:rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
