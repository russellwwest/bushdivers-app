  ...
  return (
    <nav
      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className={`${!showMenu ? 'hidden' : ''} justify-between items-center w-full md:flex md:w-auto md:order-1`} id="mega-menu-full">
          <ul
      ...
      <div id="mega-menu-full-dropdown"
           className={`${!showHQ ? 'hidden' : ''} mt-1 bg-white border-gray-200 shadow-sm border-y dark:bg-gray-800 dark:border-gray-600`}>
        <div
